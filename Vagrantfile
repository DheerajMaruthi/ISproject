...
Vagrant.configure('2') do |config|
    config.vm.define 'instructscience', primary: true do |instructscience|
        ...
        instructscience.vm.box = 'ubuntu/bionic64'
        instructscience.vm.hostname = 'InstructScience'
        ...
        instructscience.vm.network 'forwarded_port', guest: 8030, host: 8030, host_ip: '127.0.0.1'
        # instructscience.vm.network 'forwarded_port', guest: 5432, host: 5432, host_ip: '127.0.0.1'
        ...
        instructscience.vm.synced_folder './', '/home/vagrant/workspace/instructscience'
        # Provider-specific configuration so you can fine-tune various
        # backing providers for Vagrant. These expose provider-specific options.
        # Example for VirtualBox:
        #
        instructscience.vm.provider 'virtualbox' do |vb|
            # Display the VirtualBox GUI when booting the machine
            # vb.gui = true
            # Customize the amount of memory on the VM:
            vb.memory = '1024'
            vb.cpus = 1
            vb.name = 'InstructScience'
        end
        #
        ...
        instructscience.vm.provision 'shell', inline: <<-SHELL
            TEXT_RESET='\e[0m'
            TEXT_BLINK='\e[5m'
            TEXT_YELLOW='\e[0;33m'
            TEXT_BLUE='\e[34m'
            ...
            if ! grep -q VIRTUALENV_ALREADY_ADDED /home/vagrant/.bashrc; then
                ...
                echo "export EmbassyCovid_ENV='DEV'" >> /home/vagrant/.bashrc
            ...
            echo "---------------------------------"
            echo "${TEXT_YELLOW}EmbassyCovid server is available on port 8055 ${TEXT_RESET}"
            echo "         (you have to use 127.0.0.1 as opposed to 'localhost')"
            echo "Head over to$TEXT_BLUE$TEXT_BLINK http://localhost:8055$TEXT_RESET to get started"
        SHELL
    end
